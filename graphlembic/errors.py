...
class GraphlembicScriptParserError(GraphlembicErrorMixin, Exception):
    def __init__(self, script_name: str, message: str) -> None:
        super().__init__([f"Script name: {script_name}", f"Error message: {message}"])
